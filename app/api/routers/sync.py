...
class TriggerRequest(BaseModel):
    modo: str  # "bookmarks" | "bookmarks-rapido" | "fic" | "epub" | "marcados" | "suscripciones" | "wips"
    url: str | None = None
...
def disparar_sync(payload: TriggerRequest):
    ...
    if payload.modo not in {"bookmarks", "bookmarks-rapido", "fic", "epub", "marcados", "suscripciones", "wips"}:
